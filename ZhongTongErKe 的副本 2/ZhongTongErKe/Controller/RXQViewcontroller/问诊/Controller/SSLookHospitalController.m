...
@interface SSLookHospitalController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SSLookHospitalController
...
- (void)searchBtnClick{
    ...
    SSHospitalListController *hospitalListVC = [[SSHospitalListController alloc]init];
     hospitalListVC.adminiArray = self.adminiArray;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    {
      SSHospitalListController *hospitalVC =     [SSHospitalListController new];
        
        hospitalVC.administrative = weakSelf.adminiArray[titleButton.tag];
        hospitalVC.adminiArray = weakSelf.adminiArray;
