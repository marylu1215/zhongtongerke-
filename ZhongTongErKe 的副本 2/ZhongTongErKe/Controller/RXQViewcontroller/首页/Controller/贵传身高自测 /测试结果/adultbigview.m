...
#import <Masonry.h>
@implementation adultbigview

-(id)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        _oneLabel = [[UILabel alloc]init];
        _oneLabel.text = @"160.0m";
        ...
        _twoview = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"成年后标准身高"]];
        ...
        [_twoview mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.size.mas_equalTo(CGSizeMake(90, 210));
        }];
