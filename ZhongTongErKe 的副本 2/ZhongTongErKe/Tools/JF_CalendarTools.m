...
//返回当前日
+(int)getHolidayDateWithHolidayDateStr:(NSString *)holidayDate{
    
    
    NSDate *date;
    
    long long holiday=[holidayDate longLongValue];
    
    date = [NSDate dateWithTimeIntervalSince1970:holiday/1000.0];
    ...
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
    [dateFormatter setDateFormat:@"yyyy-MM-dd"];
    nowDateComps = [calendar components:NSCalendarUnitYear|NSCalendarUnitMonth|NSCalendarUnitDay fromDate:date];
