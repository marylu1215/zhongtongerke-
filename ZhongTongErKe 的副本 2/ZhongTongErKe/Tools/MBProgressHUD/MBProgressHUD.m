...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    NSMutableDictionary *labelArrt = [NSMutableDictionary dictionary];
    labelArrt[NSFontAttributeName] = label.font;
    
    CGSize labelSize = [label.text sizeWithAttributes:labelArrt];
    ...
    NSMutableDictionary *detailsLabelArrt = [NSMutableDictionary dictionary];
    detailsLabelArrt[NSFontAttributeName] = detailsLabel.font;
    
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:detailsLabelArrt context:nil].size;
