...
@implementation SSChooseDoctorCell
...
- (void)makeConstraits{
    ...
    [self.nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(48*kScreenWidthScale, 14*kScreenHeightScale));
    ...
    [self.describeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(124*kScreenWidthScale);
    }];
    [self.detailLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(26*kScreenHeightScale);
        make.size.mas_equalTo(CGSizeMake(290*kScreenWidthScale, 31*kScreenHeightScale));
        make.left.mas_equalTo(70*kScreenWidthScale);
